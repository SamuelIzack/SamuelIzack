...
- Estudando **JavaScript**, com ênfase em **Node.js** e **Express.js** para construção de **APIs REST**
- Aprofundando conhecimentos em back-end e lógica de sistemas
- Buscando evoluir cada vez mais na área de desenvolvimento e integração de sistemas

---

### 💼 Projetos

**📦 Sistema de Gestão de Terminais de Pagamento**
Projeto de extensão da Faculdade Senac Minas, desenvolvido para uma empresa real do setor de maquininhas de cartão. O sistema cobre todo o ciclo de vida dos equipamentos: cadastro, acompanhamento e controle de estoque das maquininhas, aplicando regras e processos de negócio reais da operação.
